...
import { loadAchievements, ACHIEVEMENT_DEFINITIONS, Achievement, AchievementProgress } from '../src/services/achievementService';
...
export default function AchievementsScreen() {
  ...
  useEffect(() => {
    loadAchievements().then(setProgress);
  }, []);
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#f0f4f8', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  icon: { fontSize: 24 },
  info: { flex: 1 },
